  ...
  const projects = [
    {
      ...
      description: "Notes App adalah web app catatan yang dibangun menggunakan teknologi React JS yang terhubung dengan API.",
    ...
    },
    {
      ...
      description: "Setak merupakan games senam otak teka-teki yang terinspirasi dari game Hangman. Project ini pada Front-Endnya dibuat menggunakan React JS kemudian untuk Back-Endnya dibuat menggunakan Express JS dan Prisma ORM dengan database SQLite",
    ...
    },
    {
      ...
      description: "Project ini terinspirasi dari sebuah situs download video atau musik yang berasal dari youtube, Situs tersebut yaitu y2mate. Project ini dibuat menggunakan React JS dan Chakra UI sebagai Framework CSSnya.",
    ...
    },
    {
      ...
      description: "Project ini dibuat menggunakan JavaScript yang dikombinasikan dengan library-library npm lainnya. Pada project ini juga mengusung fitur Progressive Web Apps (PWA) dan juga memanfaatkan indexedDB sebagai penyimpanan sementara untuk penambahan favorit restoran.",
    ...
    },
    {
      ...
      description: "Project ini menampilkan list resep-resep internasional. Project ini terbuat JavaScript yang dikombinasikan dengan library-library npm lainnya. Pada project ini juga memanfaatkan API untuk pengambilan data.",
    ...
    },
    {
      ...
      description: "Project ini menggunakan JavaScript. Pada project ini pengguna dapat menambah, mengedit, menghapus, buku apa saja yang dibaca ataupun belum dibaca. Pada project ini penyimpanan yang digunakan ialah Web Storage, web storage yang dipakai ialah local storage.",
